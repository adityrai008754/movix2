...
const DetailsBanner = ({ video, crew }) => {
    ...
    // console.log(url[images].base_url)
    // console.log(url.images.base_url +'original');
                                        ...
                                        <div className="right">
                                            ...
                                            <div className="info">
                                                {data.status && <div className="infoItem">
                                                    ...
                                                    <span className="text bold">{data.status}</span>
                                                </div>}
                                                {data.release_date && <div className="infoItem">
                                                    <span className="text bold">Release date: {""}</span>
                                                    <span className="text bold">{dayjs(data.release_date).format("MMM D, YYYY")}</span>
                                                </div>}
                                                {data.runtime && <div className="infoItem">
                                                    <span className="text bold">Runtime : {""}</span>
                                                    <span className="text bold">{toHoursAndMinutes(data.runtime)}</span>
                                                </div>}
                                            </div>
                                            {director?.length > 0 && (
                                                <div className="info">
